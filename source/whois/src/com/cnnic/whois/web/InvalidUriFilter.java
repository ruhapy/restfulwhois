...
public class InvalidUriFilter implements Filter {
	...
	public void doFilter(ServletRequest arg0, ServletResponse arg1,
		...
		if (StringUtils.isBlank(path)) {
			displayErrorMessage(request, response, chain, format);
			return;
		}
	...
	private void displayErrorMessage(HttpServletRequest request,
			...
			FormatType formatType) throws IOException, ServletException {
		...
		viewResolver.writeResponse(formatType, request, response, resultMap, 0);
	}
}